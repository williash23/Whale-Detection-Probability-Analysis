...
#Smaller dataframe
myvars <- c("Ship", "Count", "Vessel_Kts", "distance", "Behavior", "Visibility", "SeaState", "Year")
...
save(bin_data, file="bin_data.RData")
write.csv(bin_data, file = "bin_data.csv")


##############################################################################
##############################################################################
#Another method of truncation - did not use
